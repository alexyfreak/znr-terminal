...
import { Settings, User, Plus, Clock, ArrowUpDown, PanelLeftClose, PanelLeft, Bug, Diamond, Zap, Shield, LogOut, AlertCircle } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-zn-border py-2 px-2 flex flex-col gap-0.5 shrink-0">
        ...
        {role !== 'admin' && (
          confirmLogout ? (
            <div className="px-3 py-2 space-y-2 border-t border-zn-border mx-2 pt-3">
            ...
            >
              ...
              {isExpanded && <span className="whitespace-nowrap">{t('account.logout')}</span>}
            </button>
          )
        )}
      </div>
